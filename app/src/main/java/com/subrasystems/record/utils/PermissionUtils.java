...
public class PermissionUtils {
    ...
    */
    ...
    private PermissionUtils(Context context, String[] permissions) {
        this.context = context;
        this.PERMISSIONS = permissions;
    }

    public static PermissionUtils getInstance(Context context, String... permissions) {
        if (mInstance == null) {
            mInstance = new PermissionUtils(context, permissions);
        }
        return mInstance;
    }
